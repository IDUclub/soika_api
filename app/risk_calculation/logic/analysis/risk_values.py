...
# TODO: вынести общие для риск вальюз и сошиал риск методы в отдельный модуль
class RiskValues:
    @staticmethod
    ...
    async def calculate_values_to_risk_data(self, territory_id, project_id):
        ...
        score_df = await risk_calculation.summarize_risk(scored_texts)
        risk_series = await risk_calculation.map_risk_score(score_df)
