...
from app.common.storage.fileserver import data_getter
...
class DisposableJSON(IDisposable):
    ...
    def try_init(self, bucket_name: str, object_name: str):
        ...
        received_bytes: io.BytesIO = data_getter.get_bytes(bucket_name, object_name)
        ...
        self.json = data_getter.get_json(object_name, received_bytes)
